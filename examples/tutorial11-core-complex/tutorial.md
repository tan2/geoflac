...
This tutorial guides you through the physical principles, model setup, boundary conditions, and visualization of a **Metamorphic Core Complex (MCC)** crustal extension simulation using **GeoFLAC**.
...
## 4. Inhomogeneities (The Weak Seed)
...
1. **`core_complex.png`**: A detailed, publication-ready two-panel plot of the final state (1.8 Myr) showing detachment faulting, exhumation velocity vectors, and temperature isotherms advection.
2. **`plots/evolution_core_complex.png`**: An evolutionary chart showing how the shear bands and detachment faults develop over time.
...
In the upper panel of `core_complex.png`, you will observe that strain localizes into a low-angle shear band originating from the central weak seed and cutting through the brittle upper crust. This is the **detachment fault**. 
